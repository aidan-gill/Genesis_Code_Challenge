...
// Code is generated on: 27/04/2019 23:08:22
//
...
[assembly: EdmRelationshipAttribute("OrderModel", "FK_Order_Customer", "Customer", RelationshipMultiplicity.One, typeof(OrderModel.Customer), "Orders", RelationshipMultiplicity.Many, typeof(OrderModel.Order), true)]
...
namespace OrderModel
{
    ...
    public partial class OrderEntities : ObjectContext
    {
        ...
        public OrderEntities() : 
                base(@"name=OrderModelConnectionString", "OrderEntities")
        {
...
namespace OrderModel
{
    ...
    /// <summary>
    /// There are no comments for OrderModel.Customer in the schema.
    /// </summary>
    /// <KeyProperties>
    /// Id
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="OrderModel", Name="Customer")]
    [Serializable()]
    ...
    public partial class Customer : EntityObject    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("OrderModel", "FK_Order_Customer", "Orders")]
        public virtual EntityCollection<Order> Orders
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedCollection<Order>("OrderModel.FK_Order_Customer", "Orders");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.InitializeRelatedCollection<Order>("OrderModel.FK_Order_Customer", "Orders", value);
                }
            }
        }
    ...
    /// <summary>
    /// There are no comments for OrderModel.Order in the schema.
    /// </summary>
    /// <KeyProperties>
    /// Id
    /// </KeyProperties>
    ...
    public partial class Order : EntityObject    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("OrderModel", "FK_Order_Customer", "Customer")]
        public virtual Customer Customer
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<Customer>("OrderModel.FK_Order_Customer", "Customer").Value;
            }
            set
            {
                ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<Customer>("OrderModel.FK_Order_Customer", "Customer").Value = value;
            }
        }
        ...
        public EntityReference<Customer> CustomerReference
        {
            get
            {
                return ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<Customer>("OrderModel.FK_Order_Customer", "Customer");
            }
            set
            {
                if (value != null)
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.InitializeRelatedReference<Customer>("OrderModel.FK_Order_Customer", "Customer", value);
                }
                else 
                {
                    ((IEntityWithRelationships)(this)).RelationshipManager.GetRelatedReference<Customer>("OrderModel.FK_Order_Customer", "Customer").Value = null;
                }
            }
        }
